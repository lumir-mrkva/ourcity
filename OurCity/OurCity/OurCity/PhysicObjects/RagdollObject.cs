...
namespace OurCity.PhysicObjects
{
    public class RagdollObject : PhysicObject
    {
        ...
        public RagdollObject(ConceptGameScreen game, Model capsule, Model sphere, Model box, RagdollType type, float density)
            : base(game)
        {
            ...
            limbs[(int)LimbId.Head] = new SphereObject(this.GameplayScreen, sphere, 0.15f, Matrix.Identity, Vector3.Zero);
            limbs[(int)LimbId.UpperLegLeft] = new CapsuleObject(this.GameplayScreen, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.UpperLegRight] = new CapsuleObject(this.GameplayScreen, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.LowerLegLeft] = new CapsuleObject(this.GameplayScreen, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.LowerLegRight] = new CapsuleObject(this.GameplayScreen, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.UpperArmLeft] = new CapsuleObject(this.GameplayScreen, capsule, 0.07f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.UpperArmRight] = new CapsuleObject(this.GameplayScreen, capsule, 0.07f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.LowerArmLeft] = new CapsuleObject(this.GameplayScreen, capsule, 0.06f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int)LimbId.LowerArmRight] = new CapsuleObject(this.GameplayScreen, capsule, 0.06f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);

            if (type == RagdollType.Complex)
            {
                limbs[(int)LimbId.FootLeft] = new SphereObject(this.GameplayScreen, sphere, 0.07f, Matrix.Identity, Vector3.Zero);
                limbs[(int)LimbId.FootRight] = new SphereObject(this.GameplayScreen, sphere, 0.07f, Matrix.Identity, Vector3.Zero);
                limbs[(int)LimbId.HandLeft] = new SphereObject(this.GameplayScreen, sphere, 0.05f, Matrix.Identity, Vector3.Zero);
                limbs[(int)LimbId.HandRight] = new SphereObject(this.GameplayScreen, sphere, 0.05f, Matrix.Identity, Vector3.Zero);
                limbs[(int)LimbId.Torso] = new BoxObject(this.GameplayScreen, box, new Vector3(0.2f, 0.4f, 0.35f), Matrix.Identity, Vector3.Zero);
                limbs[(int)LimbId.Hips] = new BoxObject(this.GameplayScreen, box, new Vector3(0.2f, 0.2f, 0.35f), Matrix.Identity, Vector3.Zero);
            }
            else
            {
                limbs[(int)LimbId.Torso] = new BoxObject(this.GameplayScreen, box, new Vector3(0.2f, 0.6f, 0.35f), Matrix.Identity, Vector3.Zero);
            }
