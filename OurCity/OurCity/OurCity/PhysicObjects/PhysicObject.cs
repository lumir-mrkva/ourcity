...
namespace OurCity.PhysicObjects
{
    ...
    public abstract class PhysicObject : DrawableGameComponent
    {
        ...
        protected ConceptGameScreen gameScreen;
        protected Vector3 scale = Vector3.One;

        public Body PhysicsBody{get { return body; }}
        public CollisionSkin PhysicsSkin{ get { return collision; }}
        public ConceptGameScreen GameplayScreen { get { return gameScreen; } }

        protected static Random random = new Random();

        public PhysicObject(ConceptGameScreen game, Model model)
        ...
        public PhysicObject(ConceptGameScreen game)
            : base(game.ScreenManager.Game)
        {
            this.model = null;
            color = new Vector3(random.Next(255), random.Next(255), random.Next(255));
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (GameplayScreen.DebugDrawer.Enabled)
            {
                ...
                GameplayScreen.DebugDrawer.DrawShape(wf);
            }
