...
namespace OurCity
{
        ...
        public class Fonts : IDisposable
        {
            ...
            /// </summary>
            public Fonts(GraphicsDevice gd)
            {
                if (gd == null)
                {
            ...
            public void LoadContent(ContentManager content)
            {
                ...
                fonts.Add(content.Load<SpriteFont>("Fonts/debug"));
                fonts.Add(content.Load<SpriteFont>("Fonts/FpsFont"));
                fonts.Add(content.Load<SpriteFont>("Fonts/gamefont"));
                fonts.Add(content.Load<SpriteFont>("Fonts/menufont"));
            }
