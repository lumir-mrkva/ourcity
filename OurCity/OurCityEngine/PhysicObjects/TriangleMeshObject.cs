...
{
    /// <summary>
    /// Triangle mesh object - complex collision skin is automatically generated form vertex indices
    /// </summary>
    public class TriangleMeshObject : PhysicObject
    {
            ...
            : base(game, model)
        {
            ...
            collision.AddPrimitive(triangleMesh,new MaterialProperties(0.8f,0.7f,0.5f));
