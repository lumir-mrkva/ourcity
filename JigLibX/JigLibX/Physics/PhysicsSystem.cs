...
namespace JigLibX.Physics
{
    ...
    public class PhysicsSystem
    {
...
#if WINDOWS_PHONE
        public const int MaxLocalStackFloats = 2048;
        const int InitialLocalStackDepth = 10;
        static Stack<float[]> freeFloats = new Stack<float[]>();

        /// <summary>
        /// FloatStackAlloc
        /// </summary>
        /// <returns>int[]</returns>
        public static float[] FloatStackAlloc() {
          if (freeFloats.Count == 0) {
            // BEN-OPTIMISATION: Pushing a popping is a slow operation, don't do it unnecessarily.
            return (new float[MaxLocalStackFloats]);
          }
          return freeFloats.Pop();
        }
        ...
        public static void FreeStackAlloc(float[] alloced) {
          freeFloats.Push(alloced);
        }
        ...
        /// <param name="firstContact"></param>
        /// <returns>bool</returns>
        private bool ProcessCollisionCombined(CollisionInfo collision, float dt, bool firstContact)
        {
            collision.Satisfied = true;
            ...
            float[] impulses = FloatStackAlloc();
        ...
        static PhysicsSystem()
        {
            ...
            for (int i = 0; i < InitialLocalStackDepth; ++i) {
              freeFloats.Push(new float[MaxLocalStackFloats]);
            }
#endif
        }
