...
#if WINDOWS_PHONE
                this.collInfo[0] = new SmallCollPointInfo(boxPos - body0Pos, boxPos - body1Pos, depth);

                collisionFunctor.CollisionNotify(ref info, ref dir, this.collInfo, 1);
#else
                unsafe
                {
...
#if WINDOWS_PHONE
        SmallCollPointInfo[] collInfo = new SmallCollPointInfo[1];
#endif
